...
.LINK
    https://github.com/INTPTT-Jemery/PowerShell
    
.NOTES
    File Name      : Automate-Module.psm1
    Author         : Jon Emery (Jememry@intptt.com) & Chuck Fowler (Chuck@Braingears.com)
    Version        : 1.0
...
.NOTES
    Version        : 1.0
    Author         : Jon Emery & Chuck Fowler
    Website        : intptt.com & braingears.com
...
PROCESS
{
    ...
    $CheckAutomateWinRM = {
        ...
        Invoke-Expression(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/INTPTT-Jemery/PowerShell/master/Automate-Module.psm1')
        Confirm-Automate -Silent
    ...
    $InstallAutomateWinRM = {
        ...
        $Silent = $Args[4]
        $Transcript = $Args[5]
        Invoke-Expression(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/BINTPTT-Jemery/PowerShell/master/Automate-Module.psm1')
        Install-Automate -Server $Server -LocationID $LocationID -Token $Token -Transcript
    }
    $WMICMD = 'powershell.exe -Command "Invoke-Expression(New-Object Net.WebClient).DownloadString(''https://raw.githubusercontent.com/INTPTT-Jemery/PowerShell/master/Automate-Module.psm1''); '
